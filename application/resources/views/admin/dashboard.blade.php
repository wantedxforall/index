                ...
                <a href="{{route('admin.service.index')}}">
                    <div class="card prod-p-card background-pattern-white bg--primary">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5 text-white">@lang('Total Post')</h6>
                                    <h3 class="m-b-0 text-white">{{__($widget['total_post'])}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon fa-solid fa-signs-post text-white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{route('admin.service.pending')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Pending Post')</h6>
                                    <h3 class="m-b-0">{{__($widget['pending_post'])}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon fa-brands fa-ioxhost"></i>
                                </div>
                            </div>
                        </div>
                    </div>
