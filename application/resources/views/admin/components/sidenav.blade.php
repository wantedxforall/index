    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.service.proofs')}}">
                    <a href="{{ route('admin.service.proofs') }}" class="nav-link"
                       data-default-url="{{ route('admin.service.proofs') }}">
                        <i class="menu-icon fa-solid fa-image"></i>
                        <span class="menu-title">@lang('Proofs')</span>
                    </a>
                </li>
