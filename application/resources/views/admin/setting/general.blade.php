                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Per Post Deduct Credits')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <input class="form-control" type="text" name="deduct_credits" required
                                        value="{{$general->deduct_credits}}">
                                </div>
                            </div>

                            <div class="row mb-5">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Per Task Earn Credits')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <input class="form-control" type="text" name="add_credits" required
                                        value="{{$general->add_credits}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Initial Given Credits')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <input class="form-control" type="text" name="given_credits" required
                                        value="{{$general->given_credits}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-2 col-sm-6 mb-4">
                            <label class="fw-bold">@lang('Auto Post Approved?')</label>
                            <label class="switch m-0">
                                <input type="checkbox" class="toggle-switch" name="auto_approved" {{ $general->auto_approved ?
                                'checked' : null }}>
                                <span class="slider round"></span>
                            </label>
                        </div>
